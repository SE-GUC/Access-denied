...
class ApplyOnTask extends Component
{
    ...
    render(){
        ...
        <div>
            ...
            {this.state.changed ? (this.state.type==='Members'?
    <ApplyMemberTask className="ApplicationForm" taskID={taskid} tokenchild={this.state.token}/>
    :
        <ApplyConsultancyTask className="ApplicationForm" taskID={taskid} tokenchild={this.state.token}/>):null
    }
