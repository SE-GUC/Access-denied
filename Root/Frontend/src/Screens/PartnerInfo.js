...
function PartnerInfo(){
    return(
        ...
        <input type="text" name="Telephone_number" id="input3" value="0106561155" readOnly/>
        <button >edit</button><br/>

        <input type="text" name="address" id="input3" value="cairo" readOnly/>
        <button >edit</button><br/>

        <input type="text" name="field of work" id="input4" value="software engineering" readOnly/>
        <button >edit</button><br/>
