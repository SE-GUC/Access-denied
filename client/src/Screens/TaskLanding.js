      ...
      <div>
        ...
        >
          ...
          <small style={{ fontStyle: 'italic' }}>
            Lirten Hub offers a variety of tasks that fit every individual's
          ...
          <Row className="justify-content-center">
            <Card style={{ padding: '50px', width: '60%' }}>
              <Card.Body>
                ...
                <Card.Text>
                  Explore Lirten Hub's tasks that are sure to fit anyone and
                  everyone !
                </Card.Text>
                  ...
                  return (
                    <ListGroup.Item>
                      ...
                      <p>
                        ...
                        >
                          {!value.isComplete ? 'Not Finished' : 'Finshed'}
                        </span>
                      </p>
                      <p>
                        <span class="w3-tag w3-blue">Phase: {value.phase}</span>
                      </p>
                    </ListGroup.Item>
                  )
                })}
